...
OAuth2::OAuth2(QWidget* parent)
{
    ...
    m_strScope = "https://www.googleapis.com/auth/youtube";
    m_strClientID = "710604470749-1lkqku8b7f56np6m0kmg17acsndm33fi.apps.googleusercontent.com";
    m_strRedirectURI = "https://www.example.com/back";
    m_strResponseType = "token";

    m_strCompanyName = "OpenBoard"; //You company here
    m_strAppName = "OpenBoardTest"; //Your application name here
