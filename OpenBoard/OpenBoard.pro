...
win32:CONFIG(release, debug|release): LIBS += -LE:/Qt/QtMEL-master/libsQt5/ -lqtmel1
else:win32:CONFIG(debug, debug|release): LIBS += -LE:/Qt/QtMEL-master/libsQt5/ -lqtmeld1
